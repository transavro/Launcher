...
public class MovieDetails implements Parcelable {
    ...
    private String overview = "An insomniac office worker, looking for a way to change his life, crosses paths with a devil-may-care soapmaker, forming an underground fight club that evolves into something much, much more.";
    private boolean video = false;
    private List<Genre> genres;
    private String title = "Fight Club";
    private float popularity = 268;
    ...
    private String releaseDate = "1999-10-15";
    @SerializedName("poster_path")
    private String posterPath = "https://images-na.ssl-images-amazon.com/images/M/MV5BMzFjMWNhYzQtYTIxNC00ZWQ1LThiOTItNWQyZmMxNDYyMjA5XkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_QL50_SY1000_CR0,0,675,1000_AL_.jpg";
    @SerializedName("original_title")
    private String originalTitle = "Fight Club";
    @SerializedName("original_language")
    private String originalLanguage = "English";
    @SerializedName("backdrop_path")
    private String backdropPath = "https://images-na.ssl-images-amazon.com/images/M/MV5BMzFjMWNhYzQtYTIxNC00ZWQ1LThiOTItNWQyZmMxNDYyMjA5XkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_QL50_SY1000_CR0,0,675,1000_AL_.jpg";
    ...
    private String director = "David Fincher";
